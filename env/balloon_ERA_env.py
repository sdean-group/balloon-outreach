...
from env.ERA_wind_field import WindField, WindVector
...
class BalloonERAEnvironment:
    """Environment for balloon navigation"""
    def __init__(self, ds: xr.Dataset, start_time: dt.timedelta, noise_seed: int = None):
        """
        Parameters
        ----------
        ds : xarray.Dataset
        ...
        noise_seed : int, optional
            Seed for the noise model in wind_field. If None, a random seed is chosen.
        """
        self.wind_field = WindField(ds=ds, start_time=start_time, noise_seed=noise_seed)
